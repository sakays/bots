...
###############################################$
$config['deviceCode']           = '100d8559090005e1ca4$
$config['token']                ='5a3ebcbba6e10b58e3135a806ff7c157$
$config['uuid']                 = '611cd973-9b9e-4328-990e-2a723690656e$
###############################################$
